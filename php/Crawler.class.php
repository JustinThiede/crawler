...
class Crawler
{
    ...
    public function crawl($url)
    {
        ...
        foreach ($anchors as $element) {
            ...
            $urlHost = isset($urlParts['host']) ? $urlParts['host'] : '';
            $urlPath = isset($urlParts['path']) ? $urlParts['path'] : '';
            $hrefScheme = isset($hrefParts['scheme']) ? $hrefParts['scheme'] : '';
            $hrefHost = isset($hrefParts['host']) ? $hrefParts['host'] : '';
            $hrefPath = isset($hrefParts['path']) ? $hrefParts['path'] : '';
            ...
            if ($domainAllowed && $linkAllowed && $schemeAllowed && $fileAllowed) {
                 ...
                 */
                if ((isset($href{0}) && $href{0} == '/') && (isset($href{1}) && $href{1} == '/')) {
    ...
    private function domainAllowed($href)
    {
        ...
        $hasHttp = strpos($href, 'http') !== false
                   || ((isset($href{0}) && $href{0} == '/') && (isset($href{1}) && $href{1} == '/')) ? true : false;
     ...
     */
    private function hasFileEnding(...$arguments) 
    {
        $href = $arguments[0];
        $killEnding = $arguments[1] ?? false;
        $urlPathParts = &$arguments[2] ?? '';
